  ...
  return (
    ...
    >
      ...
      <div className="hanh-dong">
        <button onClick={handleYeuThich} aria-pressed={laYeuThich} className={laYeuThich ? 'btn-thich active' : 'btn-thich'}>
          {laYeuThich ? '♥ Đã thích' : '♡ Yêu thích'}
        </button>
        <button onClick={handleChiaSe} className="btn-chia-se">
